...
export const EditSpareGroup = () => {
	...
	const { spareGroup, message, editSpareGroup } = useContext(spareGroupContext)

	const onSubmit: SubmitHandler<IFormInput> = async (
		formData: IFormInput
	): Promise<void> => {
		console.log(formData)
		editSpareGroup(formData)
	}
							...
							<Grid container spacing={3}>
								...
								<Grid item xs={12}>
									<TextField
										...
										defaultValue={spareGroup.description}
